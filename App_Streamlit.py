...
def main():
    ...
    def get_tweets(Topic,Count):
        i=0
        #my_bar = st.progress(3000) # To track progress of Extracted tweets
        for tweet in tweepy.Cursor(api.search, q=Topic,count=3000, tweet_mode = 'extended' lang="en",exclude='retweets').items():
            #time.sleep(0.1)
            #my_bar.progress(i)
